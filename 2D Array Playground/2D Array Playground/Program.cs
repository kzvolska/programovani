    ...
    internal class Program
    {
        static void Print2DArray(int[,] arrayToPrint)
        {
            for (int i = 0; i < arrayToPrint.GetLength(0); i++) 
            {
                ...
                {
                    Console.Write(arrayToPrint[i, j] + " ");  //Console.Write .... pise do radku, Console.WriteLine ....pise do sloupce pod sebe
                }
                Console.WriteLine(); //nebo Console.Write("\n")  Console.WriteLine() ....prazdny console write line mi odentruje, neudela prazdny radek
            }
            Console.WriteLine();
        }
        ...
        {
            for (int i = 0; i < arrayToReset.GetLength(0); i++) //radky smer dolu
            {
                for (int j = 0; j < arrayToReset.GetLength(1); j++) //sloupce smer doprava
                {
        ...
        static void Main(string[] args)
        {
            ...
            int temporary = array[xFirst, yFirst]; //uloyim si prvni prve do promenne
            array[xFirst, yFirst] = array[xSecond, ySecond];
            array[xSecond, ySecond] = temporary;

            Console.WriteLine("Prohozeni prvku na pozici [" + xFirst +"," + yFirst + "]" + "] a [" + xSecond + "," + ySecond + "]");
            Print2DArray(array);
