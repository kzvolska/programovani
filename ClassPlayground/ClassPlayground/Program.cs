...
namespace ClassPlayground
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (rectangle.CalculateAspectRatio() > 1)
                Console.WriteLine("aspect ratio: " + rectangle.CalculateAspectRatio() + " the rectangle is wide");
            else if (rectangle.CalculateAspectRatio() < 1)
                Console.WriteLine("aspect ratio: " + rectangle.CalculateAspectRatio() + " the rectangle is high");
            else
                Console.WriteLine("aspect ratio: " + rectangle.CalculateAspectRatio() + " it's a square");
            if (rectangle.ContainsPoint(2, 5))
                Console.WriteLine("rectangle contains point [2,5]");
            else
            {
                Console.WriteLine("rectangle dosn't contain point [2,5]");
            }
            Console.ReadKey();
        }
    }
